...
const FamilyLearning = () => {
  ...
  const stories = selectedTopic ? allStories.filter(story => story.topics.includes(selectedTopic)) : allStories;
  ...
  return (
    <div className="font-sans text-gray-800 min-h-screen w-full" style={{backgroundColor: theme.primaryLight}}>
      {/* Add NavBar at the top */}
      <NavBar activePage="Family Learning" />
      ...
      >
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl mb-4 font-bold">Family Learning Journey</h1>
          <p className="text-lg md:text-xl mb-2">Learn together, grow together.</p>
          <p className="text-base md:text-lg opacity-90">Stories and activities for parents and children.</p>
        </div>
      </div>
        ...
        >
          <div className="p-6 h-full overflow-y-auto">
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              <p className="mt-4 font-medium" style={{color: theme.primaryDark}}>Learning together</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <select 
                ...
                style={{borderColor: theme.primaryMedium, backgroundColor: 'white'}}
              >
            ...
            >
              ...
              <p className="text-sm mb-3" style={{color: theme.primaryMedium}}>Save your narration for your child</p>
              <button 
                className={`w-full px-4 py-2 rounded text-white transition-all duration-300 ${
                  recordingMessage ? 'animate-pulse' : 'hover:shadow-md'
                }`}
                style={{backgroundColor: recordingMessage ? '#d32f2f' : theme.accentOrange}}
            ...
            <div>
              ...
              <div className="h-4 rounded-full overflow-hidden mb-2" style={{backgroundColor: `${theme.primaryLight}`}}>
                <div className="h-full w-1/3" style={{backgroundColor: theme.accentGreen}}></div>
              </div>
              <p className="text-sm" style={{color: theme.primaryDark}}>3 of 8 stories completed</p>
            </div>
              ...
              <ul className="space-y-2">
                {topics.map((topic, index) => (
                  <li 
                    ...
                    style={{
                      backgroundColor: selectedTopic === topic ? theme.accentYellow : 'transparent'
                    }}
                  ...
                  >
                    <span 
                      ...
                      style={{
                        backgroundColor: selectedTopic === topic ? theme.accentOrange : theme.accentGreen
                      }}
                    ></span>
          ...
          {!selectedStory ? (
            <div>
              <h2 
                ...
                style={{color: theme.primaryDark}}
              >
                {selectedTopic ? `${selectedTopic} Stories` : 'Choose a Story to Read Together'}
              </h2>
              <p className="mb-6 text-base" style={{color: theme.primaryMedium}}>
                {selectedTopic 
              ...
              {stories.length > 0 ? (
                        ...
                        <div className="mt-2 flex flex-wrap gap-1">
                          {story.topics.map((topic, index) => (
                            <span 
                              ...
                              style={{
                                backgroundColor: topic === selectedTopic ? theme.accentYellow : theme.primaryLight,
                ...
                >
                  <p 
                    ...
                    style={{color: theme.primaryDark}}
                  >
                    No stories found for this topic. Try selecting a different topic.
                  </p>
                  <button 
                ...
                <div key={q.id} className="mb-8">
                    ...
                    {q.options.map((option, index) => (
                      <div 
                        ...
                        className={`flex flex-col items-center p-4 rounded-lg cursor-pointer transition-all ${
                          selectedAnswer === index ? 'transform scale-105' : 'hover:shadow-md'
                        } ${
                          quizSubmitted && selectedAnswer === index 
                            ? index === q.answer ? 'ring-4 ring-green-500' : 'ring-4 ring-red-500'
                            : 'border-2'
                        }`}
                        style={{
                          backgroundColor: theme.primaryLight,
                          borderColor: selectedAnswer === index ? theme.accentYellow : 'transparent'
                        }}
                        onClick={() => !quizSubmitted && handleAnswerSelect(index)}
                      >
                        <img 
                          src={option.image} 
                          alt={option.text} 
                        ...
                        {quizSubmitted && index === q.answer && (
                          <div 
                            ...
                            style={{backgroundColor: theme.accentGreen, color: 'white'}}
                          >
                            Correct Answer
                          </div>
                        )}
                  ...
                  {!quizSubmitted && (
                    <div className="mt-6">
                      <button
                        ...
                        style={{backgroundColor: selectedAnswer !== null ? theme.accentOrange : theme.primaryMedium}}
                  ...
                  {quizSubmitted && (
                    <div 
                      ...
                      style={{
                        backgroundColor: selectedAnswer === q.answer ? theme.accentGreen : theme.accentOrange,
                        color: 'white'
                      }}
                    >
                      <p className="font-bold">
                        {selectedAnswer === q.answer 
                          ...
                          : 'Not quite right. The correct answer is "' + q.options[q.answer].text + '".'}
                      </p>
                    </div>
                  )}
                </div>
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
                ...
                <div className="mt-2 sm:mt-0">
                  <span 
                    ...
                    style={{backgroundColor: theme.accentYellow, color: theme.primaryDark}}
                  >
                    Age 5-8
                  </span>
                </div>
              ...
              <div className="my-6">
                ...
                <div className="story-text space-y-4">
                  ...
                  >
                    Once upon a time, in a lush green forest, there lived a wise old tortoise. The tortoise was known throughout the forest for solving problems and giving good advice.
                  </p>
                  <p 
                    className="leading-relaxed text-lg" 
                    style={{color: theme.primaryMedium}}
                  >
                    One day, a terrible drought came to the forest. All the animals were worried as the water in the lake began to dry up.
                  </p>
                  <p 
                    className="leading-relaxed text-lg" 
                    style={{color: theme.primaryMedium}}
                  >
                    "What shall we do?" cried the rabbit. "We will all be thirsty soon!"
                  </p>
                  <p 
                    className="leading-relaxed text-lg" 
                    style={{color: theme.primaryMedium}}
                  >
                    The wise tortoise thought carefully. "I remember a hidden spring beyond the hills," he said slowly. "But the journey is long and difficult."
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <ul className="space-y-2 pl-5 list-disc" style={{color: theme.primaryMedium}}>
                  <li>Why do you think the tortoise is described as wise?</li>
                  <li>What problem did the animals face in the forest?</li>
                  <li>Have you ever helped solve a problem for someone else?</li>
                </ul>
              </div>
            </div>
          )}
      ...
      <footer 
        ...
        style={{backgroundColor: theme.primaryDark, color: theme.primaryLight}}
      >
        <p className="text-sm">© 2025 Family Learning Journey. All stories and activities designed for educational purposes.</p>
      </footer>
    </div>
  );
};
